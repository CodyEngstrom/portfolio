export const contactLinks = {
  github: "https://github.com/CodyEngstrom",
  linkedin: "https://www.linkedin.com/in/codyengstrom",
  email: "engstrom.cody@gmail.com",
};
...
export const funFacts = [
  {
    ...
    description: "Enjoying the company of my cats and their unique personalities",
  },
  {
    icon: "🎵",
    title: "Music Lover",
    description: "Always listening to new artists, sounds, and genres",
  },
  {
    icon: "🎮",
    title: "Gaming Hobbyist",
    description: "Strategy, competitive, and indie games",
  },
  {
    icon: "🏓",
    title: "Pickleball Player",
    description: "Serving up on the court",
  },
];
